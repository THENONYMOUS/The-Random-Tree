let modInfo = {
	name: "The Sofia Tree",
	id: "Thenonymous-TheSofiaTree-839525",
	author: "thenonymous",
	pointsName: "snow",
...
function getPointGen() {
	...
	if(hasUpgrade('s', 31)) gain=gain.times(2)
	if(hasChallenge('f', 11)) gain=gain.times(player.f.points.add(1).pow(0.75))
