...
addLayer("e", {
    ...
    challenges: {
        11: {
            ...
            rewardDescription: function() {return ("Point gain is boosted based on entanglements. Currently: x"+(player.e.points.add(1).times(100).pow(0.25)))},
        ...
        12: {
            ...
            goalDescription: function() {return (challengeCompletions('e', 12).add(1).times(500))},
            rewardDescription: function() {return ("Increase Base gain based on Entanglement. Currently: +"+(player.e.points.pow(0.3).times(challengeCompletions('e', 12))))},
            completionLimit: 3,
