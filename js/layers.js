...
addLayer("e", {
    ...
    challenges: {
        ...
        12: {
            ...
            goalDescription() {return (challengeCompletions('e', 12).add(1).times(500))},
            rewardDescription() {return ("Increase Base gain based on Entanglement. Currently: +"+(player.e.points.pow(0.3).times(challengeCompletions('e', 12))))},
            completionLimit: 3,
