...
addLayer("e", {
    ...
    challenges: {
        ...
        12: {
            ...
            goalDescription: function () { return format (Decimal.times(challengeCompletions('e', 12).add(1)), 500) },
            rewardDescription: function () { return "Increase Base gain based on Entanglement. Currently: +"+format(player.e.points.pow(0.3).times(challengeCompletions('e', 12))) },
            completionLimit: 3,
