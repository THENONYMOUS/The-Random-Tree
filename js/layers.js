...
addLayer("e", {
    ...
    challenges: {
        11: {
            ...
            rewardDescription: function () { return ("Point gain is boosted based on entanglements. Currently: x" + new Decimal(player.e.points.add(1).times(100).pow(0.25))) },
        ...
        12: {
            ...
            goalDescription: function () { return new Decimal(challengeCompletions('e', 12).add(1).times(500))+" Points"},
            rewardDescription: function () { return "Increase Base gain based on Entanglement. Currently: +" + new Decimal(player.e.points.pow(0.3).times(challengeCompletions('e', 12))) },
            completionLimit: 3,
